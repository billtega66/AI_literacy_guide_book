    ...
    >
      <ContentSection title="Educational Applications of AI">
        <div className="prose prose-amber max-w-none mb-8">
          ...
          <p className="mb-4">
          As noted in Frontiers in Education [1], Artificial intelligence is changing universities of higher education by improving learning and instruction techniques, reducing administrative tasks, and pushing innovations. However, the articles also point out that the use of AI can be "challenging" if the institution does not have a clear policy on how to use AI[2]. 
          </p>
          <p className="mb-4">
          As mentioned in the section <strong>"Student use of AI" </strong>, student can gain a lot of benefit from using AI as their support from learning. For example, in the section, it also meantioned one way that student can use AI is to help them with their writing. AI can help students with their writing by providing suggestions for improving grammar, style, and clarity. This can be especially helpful for students who are non-native speakers of English or who struggle with writing.
          </p>
          <p className="mb-4">
